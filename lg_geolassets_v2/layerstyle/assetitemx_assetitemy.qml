...
<qgis styleCategories="Fields|CustomProperties" version="3.25.0-Master">
  ...
  <aliases>
    ...
    <alias field="assetitemx_assetitem" index="2" name="AssetItemX"/>
    <alias field="assetitemx_lg_geolssts_v2geolassets_assetitem" index="3" name="AssetItemX"/>
    <alias field="assetitemy_assetitem" index="4" name="AssetItemY"/>
    <alias field="assetitemy_lg_geolssts_v2geolassets_assetitem" index="5" name="AssetItemY"/>
  </aliases>
  <defaults>
    ...
    <default field="assetitemx_assetitem" expression="" applyOnUpdate="0"/>
    <default field="assetitemx_lg_geolssts_v2geolassets_assetitem" expression="" applyOnUpdate="0"/>
    <default field="assetitemy_assetitem" expression="" applyOnUpdate="0"/>
    <default field="assetitemy_lg_geolssts_v2geolassets_assetitem" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="assetitemx_assetitem" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="assetitemx_lg_geolssts_v2geolassets_assetitem" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="assetitemy_assetitem" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="assetitemy_lg_geolssts_v2geolassets_assetitem" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="T_Id" desc="" exp=""/>
    <constraint field="T_basket" desc="" exp=""/>
    <constraint field="assetitemx_assetitem" desc="" exp=""/>
    <constraint field="assetitemx_lg_geolssts_v2geolassets_assetitem" desc="" exp=""/>
    <constraint field="assetitemy_assetitem" desc="" exp=""/>
    <constraint field="assetitemy_lg_geolssts_v2geolassets_assetitem" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
