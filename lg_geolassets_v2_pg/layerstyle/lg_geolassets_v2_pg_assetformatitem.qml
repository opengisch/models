...
<qgis styleCategories="LayerConfiguration|Fields|Forms" readOnly="1" version="3.22.11-Białowieża">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" type="QString" value="assetformatitem_t_basket_fkey"/>
  ...
  <aliases>
    ...
    <alias index="17" name="MIME" field="mime"/>
    <alias index="18" name="IsSuperItem" field="issuperitem"/>
    <alias index="19" name="IsUseable" field="isuseable"/>
    <alias index="20" name="Parent" field="parent_autoobjectcatitem"/>
    <alias index="21" name="Parent" field="parent_assetkinditem"/>
    <alias index="22" name="Parent" field="parent_geomqualityitem"/>
    <alias index="23" name="Parent" field="parent_languageitem"/>
    <alias index="24" name="Parent" field="parent_pubchannelitem"/>
    <alias index="25" name="Parent" field="parent_natrelitem"/>
    <alias index="26" name="Parent" field="parent_contactkinditem"/>
    <alias index="27" name="Parent" field="parent_statusassetuseitem"/>
    <alias index="28" name="Parent" field="parent_assetformatitem"/>
    <alias index="29" name="Parent" field="parent_statusworkitem"/>
    <alias index="30" name="Parent" field="parent_mancatlabelitem"/>
    <alias index="31" name="Parent" field="parent_legaldocitem"/>
    <alias index="32" name="Parent" field="parent_autocatlabelitem"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="mime"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="mime" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="mime"/>
