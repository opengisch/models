...
<qgis styleCategories="LayerConfiguration|Fields|Forms|CustomProperties" readOnly="0" version="3.22.11-Białowieża">
  ...
  <customproperties>
    <Option type="Map">
      <Option name="dualview/previewExpressions" type="List">
        <Option type="QString" value="coalesce( attribute(get_feature('AssetItem', 'T_Id', &quot;authoredassetitem_lg_geolssts_v2geolassets_assetitem&quot;),'titlepublic'),'Kein Öffentlicher Titel vorhanden' )"/>
      </Option>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" type="QString" value="assetitem_contact_author_t_basket_fkey"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" type="QString" value="postgres"/>
            <Option name="Relation" type="QString" value="assetitem_contact_author_authoredassetitem_assettem_fkey"/>
            <Option name="ShowForm" type="bool" value="false"/>
            <Option name="ShowOpenFormButton" type="bool" value="false"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" type="QString" value="postgres"/>
            <Option name="Relation" type="QString" value="assetitem_contact_author_authrdssttm_lglssts_ssttem_fkey"/>
            <Option name="ShowForm" type="bool" value="false"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" type="QString" value="postgres"/>
            <Option name="Relation" type="QString" value="assetitem_contact_author_author_contact_fkey"/>
            <Option name="ShowForm" type="bool" value="false"/>
            <Option name="ShowOpenFormButton" type="bool" value="false"/>
          </Option>
        </config>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" type="QString" value="postgres"/>
            <Option name="Relation" type="QString" value="assetitem_contact_author_authr_lg_glssglssts_cntact_fkey"/>
            <Option name="ShowForm" type="bool" value="false"/>
            <Option name="ShowOpenFormButton" type="bool" value="false"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="2" name="AuthoredAssetItem" field="authoredassetitem_assetitem"/>
    <alias index="3" name="Asset Item" field="authoredassetitem_lg_geolssts_v2geolassets_assetitem"/>
    <alias index="4" name="Author" field="author_contact"/>
    <alias index="5" name="Author" field="author_lg_geolssts_v2geolassets_contact"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="authoredassetitem_assetitem"/>
    <default expression="" applyOnUpdate="0" field="authoredassetitem_lg_geolssts_v2geolassets_assetitem"/>
    <default expression="" applyOnUpdate="0" field="author_contact"/>
    <default expression="" applyOnUpdate="0" field="author_lg_geolssts_v2geolassets_contact"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="authoredassetitem_assetitem" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="authoredassetitem_lg_geolssts_v2geolassets_assetitem" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="author_contact" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="author_lg_geolssts_v2geolassets_contact" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="t_id"/>
    <constraint exp="" desc="" field="t_basket"/>
    <constraint exp="" desc="" field="authoredassetitem_assetitem"/>
    <constraint exp="" desc="" field="authoredassetitem_lg_geolssts_v2geolassets_assetitem"/>
    <constraint exp="" desc="" field="author_contact"/>
    <constraint exp="" desc="" field="author_lg_geolssts_v2geolassets_contact"/>
  </constraintExpressions>
  <expressionfields/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField index="3" name="authoredassetitem_lg_geolssts_v2geolassets_assetitem" showLabel="1"/>
  </attributeEditorForm>
  <editable>
