      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="OrderByValue" type="bool" value="true"/>
            <Option name="ReadOnly" type="bool" value="false"/>
            <Option name="ReferencedLayerDataSource" type="QString" value="dbname='test data' host=localhost user='postgres' key='t_id' checkPrimaryKeyUnicity='1' table=&quot;geologicalassets_01&quot;.&quot;natrelitem&quot;"/>
            <Option name="ReferencedLayerId" type="QString" value="NatRelItem_e9878fcd_49a0_4c8f_981d_cd4ebc144cee"/>
