...
<qgis styleCategories="LayerConfiguration|Fields|Forms|CustomProperties" readOnly="0" version="3.22.11-Białowieża">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" type="QString" value="assetitem_usedby_t_basket_fkey"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerProviderKey" type="QString" value="postgres"/>
            <Option name="Relation" type="QString" value="assetitem_usedby_assetitem_fkey"/>
            <Option name="ShowForm" type="bool" value="false"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="OrderByValue" type="bool" value="true"/>
            <Option name="ReadOnly" type="bool" value="false"/>
            <Option name="ReferencedLayerDataSource" type="QString" value="dbname='test data' host=localhost user='postgres' key='t_id' checkPrimaryKeyUnicity='1' table=&quot;geologicalassets_01&quot;.&quot;internalproject&quot;"/>
            <Option name="ReferencedLayerId" type="QString" value="InternalProject_f4ae3ac8_df9f_449a_aad4_667d9e8daf7c"/>
            <Option name="ReferencedLayerName" type="QString" value="InternalProject"/>
            <Option name="ReferencedLayerProviderKey" type="QString" value="postgres"/>
            <Option name="Relation" type="QString" value="assetitem_usedby_usedby_fkey"/>
            <Option name="ShowForm" type="bool" value="false"/>
            <Option name="ShowOpenFormButton" type="bool" value="false"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="3" name="UsedBy" field="usedby"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="usedby"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="1" exp_strength="0" notnull_strength="1" field="usedby" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="t_id"/>
    <constraint exp="" desc="" field="t_basket"/>
    <constraint exp="" desc="" field="assetitem"/>
    <constraint exp="" desc="" field="usedby"/>
  </constraintExpressions>
  <expressionfields/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field name="usedby" reuseLastValue="0"/>
  </reuseLastValue>
