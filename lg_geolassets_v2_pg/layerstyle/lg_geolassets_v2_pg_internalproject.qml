...
<qgis styleCategories="Fields|Forms" version="3.22.11-Białowieża">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" type="QString" value="internalproject_t_basket_fkey"/>
  ...
  <aliases>
    ...
    <alias index="3" name="Name" field="aname"/>
    <alias index="4" name="Beschreibung" field="adescription"/>
    <alias index="5" name="Datum der Abgabe des Assets" field="datedelivered"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="datedelivered"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="datedelivered" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="datedelivered"/>
  </constraintExpressions>
  <expressionfields/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="Allgemein *" showLabel="1" visibilityExpressionEnabled="0" groupBox="0" visibilityExpression="">
      <attributeEditorField index="3" name="aname" showLabel="1"/>
      <attributeEditorField index="4" name="adescription" showLabel="1"/>
      <attributeEditorField index="5" name="datedelivered" showLabel="1"/>
    ...
    <attributeEditorContainer columnCount="1" name="Assets" showLabel="1" visibilityExpressionEnabled="0" groupBox="0" visibilityExpression="">
      <attributeEditorRelation name="assetitem_usedby_usedby_fkey" showLabel="0" forceSuppressFormPopup="0" relation="assetitem_usedby_usedby_fkey" label="" nmRelationId="" relationWidgetTypeId="relation_editor">
  ...
  <reuseLastValue>
    ...
    <field name="datedelivered" reuseLastValue="0"/>
  ...
  <widgets>
    <widget name="assetitem_usedby_usedby_fkey">
      <config type="Map">
        <Option name="nm-rel" type="QString" value="assetitem_usedby_assetitem_fkey"/>
      </config>
    </widget>
  </widgets>
