...
<qgis styleCategories="LayerConfiguration|Fields|Forms" readOnly="1" version="3.22.11-Białowieża">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="FilterExpression" type="QString" value="&quot;topic&quot; = 'LG_GeolAssetsCatalogues_V2.Catalogues' and attribute(get_feature('t_ili2db_dataset', 't_id', &quot;dataset&quot;), 'datasetname') != 'Catalogueset'"/>
            ...
            <Option name="Relation" type="QString" value="natrelitem_t_basket_fkey"/>
  ...
  <defaults>
    ...
    <default expression="@default_basket_lg_geolassetscatalogues_v2_catalogues" applyOnUpdate="0" field="t_basket"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" name="Assets" showLabel="1" visibilityExpressionEnabled="0" groupBox="0" visibilityExpression="">
      <attributeEditorRelation name="typenatrel_typenatrel_fkey" showLabel="0" forceSuppressFormPopup="0" relation="typenatrel_typenatrel_fkey" label="" nmRelationId="" relationWidgetTypeId="relation_editor">
