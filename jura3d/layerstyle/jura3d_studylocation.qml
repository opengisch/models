...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties" version="3.28.10-Firenze" readOnly="0">
  ...
  <renderer-v2 referencescale="-1" symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{d2c54199-a9a7-40a5-9328-5cb98b803b3d}">
      <rule label="High Priority" filter="attribute(get_feature('AssetItem_Priority', 't_id', attribute(get_feature('AssetItem', 't_id', assetitem_ngmprd_ssts_v2geolassets_assetitem),'priority')),'dispName')='high'" symbol="0" key="{f9f7eac5-3005-41ab-bea2-bf5105d99817}"/>
      <rule label="Medium Priority" filter="attribute(get_feature('AssetItem_Priority', 't_id', attribute(get_feature('AssetItem', 't_id', assetitem_ngmprd_ssts_v2geolassets_assetitem),'priority')),'dispName')='medium'" symbol="1" key="{f9f7eac5-3005-41ab-bea2-bf5105d99817}"/>
      <rule label="Low Priority" filter="attribute(get_feature('AssetItem_Priority', 't_id', attribute(get_feature('AssetItem', 't_id', assetitem_ngmprd_ssts_v2geolassets_assetitem),'priority')),'dispName')='low'" symbol="2" key="{f9f7eac5-3005-41ab-bea2-bf5105d99817}"/>
      <rule label="Unkown Priority" filter="ELSE" symbol="3" key="{71159bf5-027c-46b0-9c0a-cca14e76d58b}"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" alpha="1" frame_rate="10" is_animated="0" name="0" type="marker" force_rhr="0">
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="150,36,153,255"/>
      ...
      <symbol clip_to_extent="1" alpha="1" frame_rate="10" is_animated="0" name="1" type="marker" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="223,130,225,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="circle"/>
            <Option name="offset" type="QString" value="0,0"/>
      ...
      <symbol clip_to_extent="1" alpha="1" frame_rate="10" is_animated="0" name="2" type="marker" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="234,171,235,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="circle"/>
            <Option name="offset" type="QString" value="0,0"/>
      ...
      <symbol clip_to_extent="1" alpha="1" frame_rate="10" is_animated="0" name="3" type="marker" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,132,39,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="circle"/>
            <Option name="offset" type="QString" value="0,0"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="OrderByValue" type="bool" value="true"/>
            <Option name="ReadOnly" type="bool" value="false"/>
            <Option name="ReferencedLayerDataSource" type="QString" value="/home/dave/qgis_projects/gpkg_moloch/testngmprod.gpkg|layername=geomqualityitem"/>
            <Option name="ReferencedLayerId" type="QString" value="GeomQualityItem_ed55d26e_d7b0_4395_8dfc_ea4a98a1262b"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerName" type="QString" value="AssetItem"/>
            <Option name="ReferencedLayerProviderKey" type="QString" value="ogr"/>
            <Option name="Relation" type="QString" value="studylocation_assetitem_ngmprd_ssts_v2geolassets_assetitem_ngmprd_ssts_v2geolassets_assetitem_T_Id"/>
            <Option name="ShowForm" type="bool" value="false"/>
