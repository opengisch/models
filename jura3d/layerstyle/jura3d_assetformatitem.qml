...
<qgis version="3.22.11-Białowieża" styleCategories="LayerConfiguration|Fields|Forms" readOnly="1">
  ...
  <aliases>
    ...
    <alias index="21" name="Parent" field="parent_mancatlabelitem"/>
    <alias index="22" name="Parent" field="parent_contactkinditem"/>
    <alias index="23" name="Parent" field="parent_assetformatitem"/>
    <alias index="24" name="Parent" field="parent_geomqualityitem"/>
    <alias index="25" name="Parent" field="parent_languageitem"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="mime"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="mime" unique_strength="0" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="mime" exp="" desc=""/>
