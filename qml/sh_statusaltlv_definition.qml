...
<qgis maxScale="0" version="3.10.13-A Coruña" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" readOnly="0">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Relation" value="statusaltlv_definition_acode_fkey_1"/>
  ...
  <aliases>
    ...
    <alias index="9" field="symbol" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="symbol" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="symbol" exp_strength="0" notnull_strength="1" constraints="1"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="234" name="t_ili_tid"/>
      <column type="field" hidden="0" width="-1" name="acode"/>
      <column type="field" hidden="0" width="-1" name="adefinition"/>
      <column type="field" hidden="0" width="414" name="adefinition_de"/>
      ...
      <column type="field" hidden="0" width="-1" name="symbol"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="2" groupBox="0" visibilityExpression="" name="General" visibilityExpressionEnabled="0" showLabel="1">
      ...
      <attributeEditorField index="9" name="symbol" showLabel="1"/>
