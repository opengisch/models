...
<qgis version="3.16.11-Hannover" styleCategories="LayerConfiguration|Symbology|Fields|Forms|MapTips" readOnly="0">
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="ewid" expression=""/>
    ...
    <default applyOnUpdate="0" field="residentialbuilding" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="1" constraints="1" exp_strength="0" unique_strength="0" field="ewid"/>
    ...
    <constraint notnull_strength="1" constraints="1" exp_strength="0" unique_strength="0" field="residentialbuilding"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="t_id"/>
    <constraint exp="" desc="" field="t_ili_tid"/>
    <constraint exp="" desc="" field="ewid"/>
    <constraint exp="" desc="" field="afloor"/>
    <constraint exp="" desc="" field="number_of_rooms"/>
    <constraint exp="" desc="" field="area"/>
    <constraint exp="" desc="" field="residentialbuilding"/>
  </constraintExpressions>
  <expressionfields/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField name="ewid" showLabel="1" index="2"/>
    <attributeEditorField name="afloor" showLabel="1" index="3"/>
    <attributeEditorField name="number_of_rooms" showLabel="1" index="4"/>
  ...
  <labelOnTop>
    ...
    <field name="ewid" labelOnTop="0"/>
    <field name="number_of_rooms" labelOnTop="0"/>
    <field name="residentialbuilding" labelOnTop="0"/>
