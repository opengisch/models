...
<qgis maxScale="0" version="3.10.13-A Coruña" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" readOnly="0">
  ...
  <customproperties>
    <property key="dualview/previewExpressions">
      ...
      <value>COALESCE( "avalue", '&lt;NULL>' )</value>
      <value>COALESCE( "avalue", '&lt;NULL>' )</value>
      <value>COALESCE( "belasteter_standort_deponietyp", '&lt;NULL>' )</value>
      <value>COALESCE( "avalue", '&lt;NULL>' )</value>
      <value>COALESCE( "avalue", '&lt;NULL>' )</value>
      <value>COALESCE( "avalue", '&lt;NULL>' )</value>
    </property>
  ...
  <fieldConfiguration>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Relation" value="deponietyp__avalue_fkey_1"/>
    ...
    <field name="belasteter_standort_deponietyp">
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="bool" name="OrderByValue" value="true"/>
            <Option type="bool" name="ReadOnly" value="false"/>
            <Option type="QString" name="Relation" value="deponietyp__belasteter_standort_dpntyp_fkey_3"/>
            <Option type="bool" name="ShowForm" value="false"/>
            <Option type="bool" name="ShowOpenFormButton" value="false"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="3" field="belasteter_standort_deponietyp" name="Deponietyp"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="belasteter_standort_deponietyp" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="belasteter_standort_deponietyp" exp_strength="0" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="t_id" exp="" desc=""/>
    <constraint field="t_seq" exp="" desc=""/>
    <constraint field="avalue" exp="" desc=""/>
    <constraint field="belasteter_standort_deponietyp" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="belasteter_standort_deponietyp"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="belasteter_standort_deponietyp" editable="1"/>
    <field name="deponietyp_dispname" editable="0"/>
    <field name="t_id" editable="1"/>
    <field name="t_seq" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="avalue" labelOnTop="0"/>
    <field name="belasteter_standort_deponietyp" labelOnTop="0"/>
    <field name="deponietyp_dispname" labelOnTop="0"/>
    <field name="t_id" labelOnTop="0"/>
    <field name="t_seq" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
  <previewExpression>COALESCE( "avalue", '&lt;NULL>' )</previewExpression>
  <mapTip></mapTip>
