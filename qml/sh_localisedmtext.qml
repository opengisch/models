...
<qgis maxScale="0" version="3.10.13-A Coruña" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" readOnly="0">
  ...
  <fieldConfiguration>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Relation" value="localisedmtext_alanguage_fkey_1"/>
    ...
    <field name="multilingualmtext_localisedtext">
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            <Option type="bool" name="AllowAddFeatures" value="true"/>
            <Option type="bool" name="OrderByValue" value="true"/>
            <Option type="QString" name="Relation" value="localisedmtext_multilingualmtxt_lclsdtext_fkey_1"/>
            <Option type="bool" name="ShowForm" value="false"/>
            <Option type="bool" name="ShowOpenFormButton" value="false"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="4" field="multilingualmtext_localisedtext" name="LocalisedText"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="multilingualmtext_localisedtext" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="multilingualmtext_localisedtext" exp_strength="0" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="multilingualmtext_localisedtext" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="multilingualmtext_localisedtext"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="2" groupBox="0" visibilityExpression="" name="General" visibilityExpressionEnabled="0" showLabel="1">
      ...
      <attributeEditorField index="4" name="multilingualmtext_localisedtext" showLabel="1"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
    <field name="alanguage" editable="1"/>
    <field name="atext" editable="1"/>
    <field name="multilingualmtext_localisedtext" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="multilingualmtext_localisedtext" labelOnTop="0"/>
